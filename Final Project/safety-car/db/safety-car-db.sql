CREATE DATABASE
IF NOT EXISTS `safety_car_db`;
USE `safety_car_db`;

CREATE TABLE
IF NOT EXISTS `carbrands`
(
  `id` bigint
...
(255) NOT NULL,
  PRIMARY KEY
(`id`),
  UNIQUE KEY `UK_jx3e7hgn1ehxcs3vvkscejr9r`
(`brandName`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

CREATE TABLE
IF NOT EXISTS `carmodels`
(
  `id` bigint
(20) NOT NULL AUTO_INCREMENT,
  `code` varchar
...
(20) DEFAULT NULL,
  PRIMARY KEY
(`id`),
  KEY `FKei9v81j9d85l3f4s1m9ivbvwl`
(`carBrand_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1315 DEFAULT CHARSET=latin1;

CREATE TABLE
IF NOT EXISTS `confirmationtoken`
(
  `token_id` bigint
(20) NOT NULL,
...
(20) NOT NULL,
  PRIMARY KEY
(`token_id`),
  KEY `FKarrepjqnsgej3429c3715doe8`
(`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

CREATE TABLE
IF NOT EXISTS `hibernate_sequence`
(
  `next_val` bigint
(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE
IF NOT EXISTS `multicriteria_table`
(
  `id` bigint
(20) NOT NULL AUTO_INCREMENT,
...
(20) DEFAULT NULL,
  PRIMARY KEY
(`id`),
  KEY `FK5q5gjkbpjmfjc0bow2w31pb4r`
(`image_id`),
  KEY `FKiy5flhp1aywbvscrscb3b06ea`
(`carModel_id`),
  KEY `FKcmgak56uxajlpnwsstgt4i7eo`
(`processedBy_id`),
  KEY `FKaqrms4wdk7e2ogke5ab8x15n2`
(`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

CREATE TABLE
IF NOT EXISTS `table_change_records`
(
  `id` bigint
(20) NOT NULL AUTO_INCREMENT,
...
(20) DEFAULT NULL,
  PRIMARY KEY
(`id`),
  KEY `FK7tiga4w7w63pegj9tf2oow6a1`
(`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
...
(30) NOT NULL,
  PRIMARY KEY
(`id`),
  UNIQUE KEY `UK_6dotkott2kjsp8vw4d0m25fb7`
(`email`),
  UNIQUE KEY `UK_r43af9ap4edm43mmtq01oddj6`
(`username`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

CREATE TABLE
IF NOT EXISTS `vehicle_registration_certificate_images`
(
  `id` bigint
(20) NOT NULL AUTO_INCREMENT,
...
INSERT INTO users (
address,email
,isEnabled, firstName,lastName, password , phone, role, username)
VALUES
('Alexander Malinov Blvd.', 'admin@admin.com', true, 'Admin', 'Adminov', '$2a$10$kZ/QhMqI3PfM.zPrf5QTYetCWL/4GnCRSqu3LeiX4YAu014bZU/oq', '0887594156', 'ADMIN', 'admin45');
